...
public final class WebviewSignedToken {
    ...
    public static Optional<VerifiedToken> verify(String token) {
        ...
        byte[] secret = WebviewServerConfig.tokenSecretBytes();
        if (secret.length == 0) return Optional.empty();
